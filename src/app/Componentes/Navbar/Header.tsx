      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative" ref={notificationsRef}>
          <button
            ...
            className="relative text-gray-600 dark:text-gray-300 hover:text-blue-500 focus:outline-none"
          >
            <Bell size={22} />
          ...
          {notificationsOpen && (
            <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
              <div className="p-4 font-bold border-b border-gray-200 dark:border-gray-700 text-gray-800 dark:text-white">
                Notificaciones
              </div>
              <ul>
              ...
              <a
                href="#"
                className="block p-4 text-center font-bold text-blue-500 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                Ver todas
              </a>
            </div>
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            <Image
              ...
              src="https://placehold.co/100x100/6366f1/white?text=U"
              alt="Foto de perfil"
              width={32}
              height={32}
            />
              ...
              <ul className="py-2">
                <li>
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      handleProfileLinkClick("editar-perfil");
                    }}
                    className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                    <Edit size={16} className="mr-3" /> Editar Perfil
                  </a>
                </li>
                <li>
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      handleProfileLinkClick("licencias");
                    }}
                    className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                ...
                <li><a href="#" onClick={(e) => { e.preventDefault(); handleProfileLinkClick('feedback'); }} className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"><FileText size={16} className="mr-3" /> Encuesta</a></li>
                <li className="border-t border-gray-200 dark:border-gray-700 my-1"></li>
                <li>
                  <a
                    href="#"
                    className="flex items-center px-4 py-2 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10"
                  >
