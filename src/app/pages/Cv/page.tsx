          ...
          <Accordion title="1. Datos Personales" defaultOpen={true}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Input
                ...
                onChange={(e) =>
                  handlePersonalDataChange("city", e.target.value)
                }
                disabled={!isEditing}
              />
              <Input
                label="Provincia/Estado"
                value={cvData.personalData.province}
                onChange={(e) =>
                  handlePersonalDataChange("province", e.target.value)
                }
                disabled={!isEditing}
              />
              <Input
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="flex items-center px-3 py-1 text-xs font-semibold text-white bg-blue-500 rounded-full">
                          {" "}
                          <BrainCircuit className="w-4 h-4 mr-1" /> Iniciar
                          Prueba{" "}
                        </span>{" "}
                      </button>
                    );
              ...
              {mockData.softSkills.map((skill) => (
                ...
                >
                  <input
                    ...
                    checked={cvData.softSkills.includes(skill.id)}
