...
export default function ConfiguracionGeneral() {
    ...
    return (
        <div className="min-h-screen bg-background p-6 font-sans antialiased text-foreground">
            ...
            {showContractModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-overlay backdrop-blur-sm" onClick={() => setShowContractModal(false)} />
                    <div className="relative bg-card w-full max-w-lg rounded-3xl border border-border shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                        <div className="flex justify-between items-center mb-6 pb-3 border-b border-border">
            ...
            {showProfessionModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-overlay backdrop-blur-sm" onClick={() => setShowProfessionModal(false)} />
                    <div className="relative bg-card w-full max-w-lg rounded-3xl border border-border shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                        <div className="flex justify-between items-center mb-6 pb-3 border-b border-border">
            ...
            {showJornadaModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-overlay backdrop-blur-sm" onClick={() => setShowJornadaModal(false)} />
                    <div className="relative bg-card w-full max-w-lg rounded-3xl border border-border shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                        <div className="flex justify-between items-center mb-6 pb-3 border-b border-border">
